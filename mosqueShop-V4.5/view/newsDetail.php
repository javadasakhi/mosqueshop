...
<body>
    ...
    <div class="container custom-container">
        <div class="main-content">
            <img id="main-pic" src="<?php echo $newImage[0]?>" alt="">
            <h2 class="mb-3"><?php echo $newDetailTitle?></h2>
            <p>
                <?php echo $newDetailContent?>
            </p>
            <ul id="news-gallery">
                <li id="img-wrapper">
                    <img src="<?php echo $newImage[1]?>" alt="">
                </li>

                <li id="img-wrapper">
                    <img src="<?php echo $newImage[2]?>" alt="">
                </li>
                <li id="img-wrapper">
                    <img src="<?php echo $newImage[3]?>" alt="">
                </li>
                <li id="img-wrapper">
                    <img src="<?php echo $newImage[4]?>" alt="">
                </li>
                <li id="img-wrapper">
                    <img src="<?php echo $newImage[5]?>" alt="">
                </li>
            </ul>
        </div>
    </div>
