...
//$normalSmallNews=substr(connectDB::query('select LongDescriptionNews from news where category=:category',array(':category'=>$normalNewsCategory))[0],0,170);
...
$sliderImage=connectDB::query('select sliderImage from news where category=:category',array(':category'=>$sliderCategory))[0]['sliderImage'];
