...
<!--===== start product area =====-->
<div class="container mb-5 py-2 rounded-bottom">
    <div class="row">
        <div class="col-12 col-md-4 mb-3">
            <div class="card custom-box border-1">
                <img class="card-img-top" src="img/product-pic.jpg" alt="">
                <div class="card-body">
                    <p class="card-title font-weight-bold text-center">محصول اول</p>
                    <p class="card-text text-center">قیمت : 200000</p>
                    <a href="./productDetail.php" class="btn btn-lg btn-outline-info btn-block">جزئیات</a>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-4 mb-3">
...
<div class="container-fluid text-white copyright p-2">
    <div class="row m-auto p-2">
        ...
        <div class="col-12 col-xl-2 mt-2 text-center">
            <a href="http://Www.instagram.com/cre.ativityworkshop" id="instagram-icon"><img src="./img/instagram.png"></a>
