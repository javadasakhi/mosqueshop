...
<body>
    ...
    <div class="container custom-container">
        <div class="main-content">
            <img id="main-pic" src="./img/photo_2020-09-26_15-48-38.jpg" alt="">
            <h2 class="mb-3">کارگاه تولید خلاق چیست و کجاست؟</h2>
            <p>
                کارگاه تولید خلاق چیست و کجاست ؟
                این کارگاه مکانی است صمیمی و در عین حال جهادی برای تمامی کسانی که به کارآفرینی
                ،تحقیق و پژوهش در حوزه اشتغال و آی تی علاقه مندند. کارگاهی که اولین نتیجه جدی ستاد
                کارآفرینان مسجد و محله است و اولین مرکز آن در مسجد جامع المهدی )عج( واقع در میدان
                بریانک تهر ان واقع است .


            </p>
            <p>
                تولیدات صنعتی، فناورانه ، نرم افزاری و تجهیزات پزشکی از جمله مهم ترین زمینه های فعالیت
                این کارگاه می باشد.
            </p>
            <p>
            ...
            <p>
                از تمامی کارآفرینان ، علاقه مندان به ایجاد اشتغال، تحقیق و پژوهش یا صاحب مهارت دعوت می
                شود جهت به اشتراک گذاری علایق خود با نخبگان این کارگاه یا جهت حمایت ما لی و معنوی
                پروپوزال ایده خویش را مطابق با استاندارد کانون رشد، پژوهش و کارآفرینی ستاد که در بخش
                خدمات ستاد قرار داد آماده نمایند و به ایمیل ما ارسال کنند تا در اسرع وقت ضمن بررسی در
                صورت تایید پروپوزال به کارگاه دعوت شوند .            </p>
            <ul id="news-gallery">
                <li id="img-wrapper">
                    <img src="./img/photo_2020-09-26_15-48-43.jpg" alt="">
                </li>

                <li id="img-wrapper">
                    <img src="./img/photo_2020-09-26_15-48-46.jpg" alt="">
                </li>
                <li id="img-wrapper">
                    <img src="./img/photo_2020-09-26_15-48-51.jpg" alt="">
                </li>
                <li id="img-wrapper">
                    <img src="./img/photo_2020-09-26_15-48-41.jpg" alt="">
                </li>
                <li id="img-wrapper">
                    <img src="./img/photo_2020-09-26_15-49-22.jpg" alt="">
                </li>
            </ul>
        </div>
    </div>
