...
<div class="container custom-container">
    <div class="main-content">
        <img id="main-pic" src="./img/photo_2020-09-26_15-49-06.jpg" alt="">
        <h2 class="mb-3">حضور ستاد کارآفرینان در دهکده مقاومت مرکز رشد شهید تهرانی مقدم</h2>
        <p>
            حضور ستاد کارآفرینان در دهکده مقاومت مرکز رشد شهید تهرانی مقدم
            به دعوت سران این مرکز در یک نمایشگاه که 99 شهریورماه 17 ستاد کارفرینان مسجد و محله در
            در مکان مرکز رشد شهید تهرانی مقدم تهران بود شرکت نمود و همپای شرکت ها و استارت آپ
            های نخبه کشور به ارائه محصولات و دستاوردهای خویش پرداخت .


        </p>
        <p>

            در این رویداد یک روزه سران لشکری و کشوری از این مراسم و غرفه ستاد کارفرینان بازدید
            نمودند و ضمن آشنایی نزدیک از فعالیت های ستاد به تشویق و تمجید نخبگان این مجموعه
            پرداختند و زمینه های خوبی جهت گس ترش فرهنگ کارآفرینی در مساجد و مراکز فرهنگی به
            وسیله ستاد کارآفرینان فراهم گردید که انشا لل به همت مسئولین و تلاش مجموعه این مهم آغاز
            خواهد شد .
        ...
        <ul id="news-gallery">
            <li id="img-wrapper">
                <img src="./img/photo_2020-09-26_15-49-09.jpg" alt="">
            </li>

            <li id="img-wrapper">
                <img src="./img/photo_2020-09-26_15-49-04.jpg" alt="">
            </li>
            <li id="img-wrapper">
                <img src="./img/photo_2020-09-26_15-49-01.jpg" alt="">
            </li>
            <li id="img-wrapper">
                <img src="./img/photo_2020-09-26_15-48-55.jpg" alt="">
            </li>
            <li id="img-wrapper">
                <img src="./img/photo_2020-09-26_15-48-59.jpg" alt="">
            </li>
        </ul>
    </div>
</div>
