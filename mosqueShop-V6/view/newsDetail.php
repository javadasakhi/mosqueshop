...
<body>
    ...
    <div class="container-fluid text-white copyright p-2">
        <div class="row m-auto p-2">
            <p class="pt-2 col-12 col-xl-8 text-center mr-xl-5">کلیه حقوق مادی و معنوی سایت محفوظ و متعلق به ستاد کارآفرینان خلاق می باشد ، هر گونه کپی برداری پیگرد قانونی دارد</p>
